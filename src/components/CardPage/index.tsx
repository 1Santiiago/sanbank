  ...
  return (
    <>
      <div className="p-4 md:p-6 max-w-4xl mx-auto space-y-8 ">
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 gap-3 p-2 mt-3">
          {cardActions.map((item) => (
            <button
              key={item.name}
              className="bg-white p-4 rounded-xl shadow-md flex items-center space-x-3 hover:bg-gray-100 transition-colors text-gray-700 w-full"
            >
